...
class Ghost:
    ...
    def draw(self):
        ...
        ghost_rect = pygame.rect.Rect((self.center_x - 12, self.center_y - 12), (24, 24))
        return ghost_rect
    ...
    def check_collisions(self):
        ...
        if 0 < self.center_x // 20 < 29:
            ...
            self.turns[0] = True
            self.turns[1] = True
        if 233 < self.x_pos < 367 and 247 < self.y_pos < 320:
            self.in_box = True
        else:
            self.in_box = False
...
def draw_misc():
    ...
    if powerup:
        pygame.draw.circle(screen, 'blue', (140, 630), 15)
    for i in range(lives):
        screen.blit(pygame.transform.scale(player_images[0], (20, 20)), (433 + i * 40, 615))
    if game_over:
        pygame.draw.rect(screen, 'white', [50, 200, 500, 300],0, 10)
        pygame.draw.rect(screen, 'dark gray', [70, 220, 460, 260], 0, 10)
...
def move_player(play_x, play_y):
    ...
    if play_x < 0:
        play_x = 0
    elif play_x > WIDTH - 30:
        play_x = WIDTH - 30
    if play_y < 0:
        play_y = 0
    elif play_y > HEIGHT - 50:
        play_y = HEIGHT - 50
...
def get_targets(blink_x, blink_y, ink_x, ink_y, pink_x, pink_y, clyd_x, clyd_y):
    ...
    if player_y < 300:
        ...
        runaway_y = 0
    return_target = (253, 267)
    if powerup:
        if not blinky.dead and not eaten_ghost[0]:
            blink_target = (runaway_x, runaway_y)
        elif not blinky.dead and eaten_ghost[0]:
            if 227 < blink_x < 373 and 227 < blink_y < 333:
                blink_target = (267, 67)
            else:
        ...
        if not inky.dead and not eaten_ghost[1]:
            ...
            if 227 < ink_x < 373 and 227 < ink_y < 333:
                ink_target = (267, 67)
            else:
        ...
        if not pinky.dead:
            ...
            if 227 < pink_x < 373 and 227 < pink_y < 333:
                pink_target = (267, 67)
            else:
        ...
        if not clyde.dead and not eaten_ghost[3]:
            ...
            if 227 < clyd_x < 373 and 227 < clyd_y < 333:
                clyd_target = (267, 67)
            else:
